...
const char *ssid = "MOVISTAR_A010";
const char *password = "TargetWlan";
char   SERVER[50]   = "m12.cloudmqtt.com"; //"m11.cloudmqtt.com"
int    SERVERPORT   = 17287;
...
void setup() {
  ...
  pinMode(LED_BUILTIN, OUTPUT); // D6 salida digital
  digitalWrite(LED_BUILTIN, LOW);
